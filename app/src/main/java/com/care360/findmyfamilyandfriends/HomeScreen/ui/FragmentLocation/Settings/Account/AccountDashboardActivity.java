...
import com.care360.findmyfamilyandfriends.SharedPreference.ResetPassword.ByPhoneNo.ResetPasswordPhoneActivity;
...
//                    Toast.makeText(App.getAppContext(), "ReadsDocs: "+ App.readCount++, Toast.LENGTH_SHORT).show();
        ...
        FirebaseFirestore.getInstance().collection(Constants.USERS_COLLECTION)
                ...
                .get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
//                    Toast.makeText(App.getAppContext(), "ReadsDocs2: "+ App.readCount++, Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(App.getAppContext(), "ReadsAccount: "+ App.readCount++, Toast.LENGTH_SHORT).show();
