...
public class BottomSheetMemberAdapter extends RecyclerView.Adapter<BottomSheetMemberAdapter.MyViewHolder> {
    ...
    public BottomSheetMemberAdapter(Context context, OnAddedMemberClickInterface onAddedMemberClickInterface, OnAddNewMemberInterface onAddNewMemberInterface) {
    ...
    public void onBindViewHolder(@NonNull BottomSheetMemberAdapter.MyViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == Constants.VIEW_TYPE_ITEM) {
            ...
            // view click listener
            recyclerViewItemBinding.consMemberBottomSheet.setOnClickListener(v -> addedMemberInterface.onAddedMemberClicked(position,memberItem));
...
//            addNewMemberBinding.bannerAd1.loadAd(adRequest);
    ...
    public interface OnAddedMemberClickInterface {
        void onAddedMemberClicked(int position,MemberDetail memberItem);
    }
