...
//                    Toast.makeText(App.getAppContext(), "ReadsLocationsMember: "+ App.readCount++, Toast.LENGTH_SHORT).show();

                    for(DocumentSnapshot doc: queryDocumentSnapshots) {
                        locationInfoList.add(new LocationInfo(Objects.requireNonNull(doc.getDouble(Constants.LAT)).toString(),
                                Objects.requireNonNull(doc.getDouble(Constants.LNG)).toString(),
