...
public class ShareCircleCodeActivity extends AppCompatActivity {
    ...
    public void BannerAds() {
        ...
        adView.setAdUnitId(com.care360.findmyfamilyandfriends.BuildConfig.BANNER_AD_ID);
...
//                    Toast.makeText(this, "Write: "+((App)getApplication()).writeCount++, Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(this, "Write: "+((App)getApplication()).writeCount++, Toast.LENGTH_SHORT).show();
                            ...
                            documentRefCircleId.update(Constants.CIRCLE_IDS, FieldValue.arrayUnion(documentReference.getId()))
                                    .addOnSuccessListener(unused ->{
                                        Log.i(TAG, "circle id added successfully in USER collection");
//                                Toast.makeText(this, "Write: "+((App)getApplication()).writeCount++, Toast.LENGTH_SHORT).show();
            ...
            Log.e("createCircle: ", e.getMessage());
    ...
    private void setAd() {
        ...
        InterstitialAd.load(
                this,
                com.care360.findmyfamilyandfriends.BuildConfig.INTERSTITIAL_AD_ID,
                adRequest,
