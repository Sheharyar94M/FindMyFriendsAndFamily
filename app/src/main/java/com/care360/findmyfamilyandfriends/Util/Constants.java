...
public interface Constants {
    ...
    //Activity Constants
    int REQUEST_CODE_ACTIVITY_TRANSITION = 123;
    int REQUEST_CODE_INTENT_ACTIVITY_TRANSITION = 122;
    int ACTIVITY_TRANSITION_NOTIFICATION_ID = 111;
    String ACTIVITY_TRANSITION_STORAGE = "ACTIVITY_TRANSITION_STORAGE";

    String ACTIVITY_COLLECTION = "Activities";
    String ACTIVITY_NAME = "activity_name";
    String ACTIVITY_TIME = "activity_time";
    String ACTIVITY_DURATION = "activity_duration";

    String WORK_TAG = "my_work_tag";
    int BACKGROUND_LOCATION_PERMISSION_CODE = 66;
    int LOCATION_PERMISSION_CODE = 200;
