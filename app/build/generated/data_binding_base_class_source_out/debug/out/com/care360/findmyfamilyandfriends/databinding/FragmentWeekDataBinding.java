...
public final class FragmentWeekDataBinding implements ViewBinding {
  ...
  @NonNull
  public final CardView listLayoutWeek;

  @NonNull
  public final MaterialCardView locationCardButtonWeek;
  ...
  @NonNull
  public final ShimmerFrameLayout shimmerLayoutWeek;

  @NonNull
  public final LayoutRecyclerViewBottomSheetBinding userProfileItemview;

  private FragmentWeekDataBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull LinearLayout linearLayout3, @NonNull CardView listLayoutWeek,
      @NonNull MaterialCardView locationCardButtonWeek,
      ...
      @NonNull ShimmerFrameLayout shimmerLayoutWeek,
    ...
    this.listLayoutWeek = listLayoutWeek;
    this.locationCardButtonWeek = locationCardButtonWeek;
    ...
    this.shimmerLayoutWeek = shimmerLayoutWeek;
  ...
  @NonNull
  public static FragmentWeekDataBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentWeekDataBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_week_data, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentWeekDataBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.list_layout_week;
      CardView listLayoutWeek = ViewBindings.findChildViewById(rootView, id);
      if (listLayoutWeek == null) {
        break missingId;
      }

      id = R.id.location_card_button_week;
      MaterialCardView locationCardButtonWeek = ViewBindings.findChildViewById(rootView, id);
      if (locationCardButtonWeek == null) {
        break missingId;
      }
      ...
      id = R.id.shimmer_layout_week;
      ShimmerFrameLayout shimmerLayoutWeek = ViewBindings.findChildViewById(rootView, id);
      if (shimmerLayoutWeek == null) {
        break missingId;
      }
      ...
      return new FragmentWeekDataBinding((ConstraintLayout) rootView, appCompatImageView,
          appCompatImageView2, appCompatImageView3, appCompatTextView3, appCompatTextView4,
          appCompatTextView5, chart, linearLayout3, listLayoutWeek, locationCardButtonWeek,
          binding_movementRecordLayout, noActivitiesFound, noDataFound, progressChart, progressList,
          shimmerLayoutWeek, binding_userProfileItemview);
    }
