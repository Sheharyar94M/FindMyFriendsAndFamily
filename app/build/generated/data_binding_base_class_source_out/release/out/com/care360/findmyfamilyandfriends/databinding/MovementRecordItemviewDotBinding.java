...
public final class MovementRecordItemviewDotBinding implements ViewBinding {
  @NonNull
  ...
  private MovementRecordItemviewDotBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static MovementRecordItemviewDotBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MovementRecordItemviewDotBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.movement_record_itemview_dot, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MovementRecordItemviewDotBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MovementRecordItemviewDotBinding((ConstraintLayout) rootView, categoryIcon,
